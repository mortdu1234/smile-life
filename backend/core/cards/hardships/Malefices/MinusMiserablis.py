...
class MinusMiserablis(MaleficeCard):
    def apply_malefice_effect(self, player: "Player", game: "Game") -> bool:
        ...
        self.target_player.add_power(Power.NO_SALARY_1)
        return True
    ...
    def discard_card(self, game: "Game", owner: "Player") -> None:
        owner.remove_power(Power.NO_SALARY_1)
        return super().discard_card(game, owner)

    
    def get_card_rule(self) -> str:
        return """aucun salaire de niveau 1 posable"""+ "\n"+ "="*10+ "\n" + super().get_card_rule()