...
class ManoNegra(MaleficeCard):
    def apply_card_effect(self, game: "Game", current_player: "Player") -> bool:
        ...
        self.target_player.add_power(Power.MANO_NEGRA)
        return True

    def discard_card(self, game: "Game", owner: "Player") -> None:
        owner.remove_power(Power.MANO_NEGRA)
        return super().discard_card(game, owner)

    
    def get_card_rule(self) -> str:
        return """déduisez vos smiles en main a la fin"""+ "\n"+ "="*10+ "\n" + super().get_card_rule()